...
I wanted a first project that combined backend fundamentals (API calls, error handling, data pipelines) with something visually satisfying to look at and interact with — watching a real spacecraft move across a map in your browser felt like a good way to make that concrete.
